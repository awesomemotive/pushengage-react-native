...
public class PushEngageReactNative: NSObject {
    ...
    @objc public func addAlert(_ alert: [String: Any], resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
        guard let typeString = alert["type"] as? String,
              let productId = alert["productId"] as? String,
              let link = alert["link"] as? String,
              let price = alert["price"] as? Double else {
    ...
    @objc public func addDynamicSegment(_ segments: [Any], resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
    ...
    @objc public func addProfileId(_ profileId: String, resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
    ...
    @objc public func addSegment(_ segments: [Any], resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
    ...
    @objc public func addSubscriberAttributes(_ attributes: [String: Any], resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
    ...
    @objc public func automatedNotification(_ status: Bool, resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
        PushEngage.automatedNotification(status: status ? .enabled : .disabled) { response, error in
            if response {
                resolve("Automated notification " + (status ? "enabled" : "disabled") + " successfully")
            } else {
    ...
    @objc public func deleteSubscriberAttributes(_ attributes: [Any], resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
    ...
    @objc public func getDeviceTokenHash(resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
        resolve("")
    }
    ...
    @objc public func getSubscriberAttributes(resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
    ...
    @objc public func getSubscriberDetails(_ values: [Any]?, resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
            ...
            if let value = response {
                ...
                do {
                    ...
                    if let jsonString = String(data: jsonData, encoding: .utf8) {
                        ...
                        reject("FAILURE", "Failed encoding JSON string", nil)
                    }
                } catch {
    ...
    @objc public func removeSegment(_ segments: [Any], resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
        guard let segments = segments as? [String] else {
            reject("INVALID_ARGUMENT", "Missing required arguments", nil)
            return
        }
    ...
    @objc public func requestNotificationPermission(resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
        PushEngage.requestNotificationPermission()
        resolve(true)
    }
    
    @objc public func sendGoal(_ goal: [String: Any], resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
    ...
    @objc public func sendTriggerEvent(_ trigger: [String: Any], resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
        guard let campaignName = trigger["campaignName"] as? String,
              let eventName = trigger["eventName"] as? String else {
            reject("MISSING_ARGUMENTS", "Missing required arguments", nil)
            return
        }
    ...
    @objc public func setSmallIconResource(_ resourceName: String, resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
        resolve("")
    }
    
    @objc public func setSubscriberAttributes(_ attributes: [String: Any], resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
